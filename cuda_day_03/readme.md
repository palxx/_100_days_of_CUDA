DAY 03 - Today I learnt about matrix addition on triton, CUDA. In CUDA we will load it on GPU, do the calculation and then free up the memory on GPU. It is same process 
